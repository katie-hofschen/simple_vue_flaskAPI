...
<!--we are exporting data from the component and a method that handles
validation and data submission on the submission of the form.-->
<script>
export default {
  name: 'AddTodo',
  data() {
    ...
    checkForm: async function(e) {
      if (this.todo.title && this.todo.description) {
        try {
          ...
          await this.$http.post("http://127.0.0.1:5000/api/todo", {
